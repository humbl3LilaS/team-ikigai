        ...
        <main className="w-full bg-background">
            ...
            <section className="">
                ...
                <div className="flex gap-3 w-full items-center px-2">
                    <OrderCard num={unfinishedOrders.count} title="Pending" color="bg-red-100 border-red-400 text-red-900" />
                    <OrderCard num={finishedOrders.count} title="Finished" color="bg-yellow-100 border-yellow-400 text-yellow-900" />
                    <OrderCard num={approvedOrders.count} title="Approved" color="bg-green-100 border-green-400 text-green-900" />
                </div>
            </section>
