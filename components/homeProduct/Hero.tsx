    ...
    <div className="flex max-w-7xl mx-auto flex-col gap-5">
        <section className="relative p-5 grid grid-cols-12 gap-4">
            <div className="col-span-12 xs:col-span-8 sm:col-span-8 flex flex-row flex-wrap sm:flex-col gap-6 md:gap-8 lg:gap-10">
                <div className="">
                    <h1 className="transition-all flex-nowrap lg:text-nowrap text-5xl sm:text-6xl lg:text-7xl leading-tight duration-500 text-[#2a384b] font-oswald font-extrabold">Get Your Best
                        <br/>
            ...
            <div className="xs:col-span-4 sm:col-span-4 relative hidden h-fit xs:block md:absolute md:-top-4 md:right-0 md:scale-75 lg:mt-4 lg:scale-100 lg:right-4">
                <Image width={300} height={300} src="/pcAds.png" alt="advertise" className="drop-shadow-2x -top-9 aspect-[1/1.5] sm:aspect-[1/1.2] scale-100 md:aspect-[1/1.05]" />
        ...
        <section className="grid  grid-cols-12 ">
                <div className="relative w-full col-span-3">
                    <Link href="/category" className="px-4 brightness-105 w-fit h-fit py-3 text-white rounded-xl border border-white text-nowrap bg-gradient-to-br from-[#b88bd0] via-[#afa5de] to-[#a8cff2] font-bold">
                        Shop Now
                    </Link>
                    ...
                    <div className="relative col-span-9 sm:col-span-5 pe-5 justify-self-end xs:justify-self-center scale-90 sm:scale-95 lg:scale-100 sm:me-0 border-[1px] w-fit xs:w-[240px] -mt-8 sm:mt-0 border-white lg:w-[270px] justify-between flex p-2 md:p-3 lg:p-4 rounded-2xl bg-[#FFFAFA] shadow-md">
                            <Image src="/laptopAds.png" width={150} height={100} alt="laptop" className="absolute scale-x-[-1]  max-w-[150px] aspect-[1/0.8] drop-shadow-2xl -top-12 flex-1 xs:-top-10 -left-3 xs:left-3 transition-hero object-cover hidden xs:block w-fit xs:w-full"/>
