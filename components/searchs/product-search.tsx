...
import { Product } from "@/features/client/category/contexts/product-context";
...
const ProductSearch = () => {
    ...
    return (
        <>
            <button
                className="flex gap-1 md:gap-3 w-full bg-gray-100 items-center md:bg-white md:border md:py-1.5 md:px-3 py-1 px-2 rounded-md"
                onClick={handleOpenSearch}
            >
                <input
                    className="md:hidden focus:outline-none w-full bg-transparent "
                    placeholder="search..."
                />
